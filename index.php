        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/indonesia3.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/thailand3.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Tours & Travel</h4>
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="img/about4.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="about-text bg-white p-4 p-lg-5 my-lg-5">
                        ...
                        <p>We live by travel; it's not only our line of work. Discovering novel experiences and sharing them with our clients are deeply important to us. For every place on our list of top destinations, we provide the greatest packages.</p>
                        <div class="row mb-4">
                            <div class="col-6">
                                <img class="img-fluid" src="img/vietnam3.jpg" alt="">
                            </div>
                            <div class="col-6">
                ...
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">We have the most competitive prices on the market. We believe in providing the most competitive prices to our customers.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">Our customers will be guided throughout their booking experience because we have an excellent customer service team.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">We provide packages from around the world.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <p class="m-0">Check out our travel guide and map.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <p class="m-0">Click here to book your ticket.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <p class="m-0">CLick here to book your hotel.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    ...
                    <p class="text-white">Sandals Grande St. Lucian has everything you need for an unforgettable honeymoon.</p>
                    <ul class="list-inline text-white m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Villas Available</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>All Inclusive</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Free wedding (if you’re staying more than 3 nights)</li>
                    </ul>
                </div>
                <div class="col-lg-5">
        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="img/guide4.jpg" alt="">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate">Amirul</h5>
                            <p class="m-0">Tour Guide</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="img/guide2.jpg" alt="">
                            <div class="team-social">
                                <a class="btn btn-outline-primary btn-square" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-outline-primary btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-outline-primary btn-square" href=""><i class="fab fa-instagram"></i></a>
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate">Jennifer</h5>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="img/guide3.jpg" alt="">
                            <div class="team-social">
                                <a class="btn btn-outline-primary btn-square" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-outline-primary btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-outline-primary btn-square" href=""><i class="fab fa-instagram"></i></a>
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate">Idlan</h5>
                            <p class="m-0">Tour Guide</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="img/guide1.jpg" alt="">
                            <div class="team-social">
                                <a class="btn btn-outline-primary btn-square" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-outline-primary btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-outline-primary btn-square" href=""><i class="fab fa-instagram"></i></a>
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate">Mathanda</h5>
                            <p class="m-0">Customer Service</p>
                        </div>
                    </div>
                </div>
