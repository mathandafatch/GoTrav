        ...
        if(!empty($username) && !empty($password) && !is_numeric($username))
        {
            ...
            if($result)
            {
                if($result && mysqli_num_rows($result) > 0)
                {
                    ...
                    $test2 = password_verify($password, $user_data['password']);
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Login Account</h3>
 ...
 <div id="box" class="bg-white">
            ...
            <div class="container">
                ...
                <div style="font-size: 20px; margin: 10px; color: white;"></div>
                    <input class="btn btn-primary btn-block" type="submit" value="Login"> <br><br>
