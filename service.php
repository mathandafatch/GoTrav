                            ...
                            <div class="col-md-3">
                                <div class="mb-3 mb-md-0">
                                    <div class="date" id="date1" data-target-input="nearest">
                                        <input type="text" class="form-control p-4 datetimepicker-input" placeholder="Depart Date" data-target="#date1" name="departdate" data-toggle="datetimepicker"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="text-center pb-4">
                    ...
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">My vacation was amazing. Thank you Go Trav.</p>
                        </p>
                        <h5 class="text-truncate">Nathan</h5>
                ...
                <div class="text-center">
                    ...
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">My family had a great trip in Bali all thanks to the Go Trav team.</p>
                        </p>
                        <h5 class="text-truncate">Linda</h5>
                ...
                <div class="text-center">
                    ...
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">Thank you Jennifer from Go Trav for your assitance. You made planning for my honey moon a breeze.</p>
                        </p>
                        <h5 class="text-truncate">Alex</h5>
                        <span>Doctor</span>
                    </div>
                </div>
                <div class="text-center">
                    ...
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">The GoTrav team is amazing, they helped me with my trip to Malaysia.</p>
                        </p>
                        <h5 class="text-truncate">Tommy</h5>
