...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        if(!empty($firstname) && !empty($secondname) && !empty($email_address) && !empty($secure_pass) && !is_numeric($firstname))
        {

            //save to database
            $user_id = random_num(10);
            $query = "insert into users (user_id, username, password,firstname, secondname, email_address, phone_no) values ('$user_id','$username','$secure_pass','$firstname','$secondname','$email_address','$phone_no')";
...
<body>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Signup Account</h3>
    ...
    <!-- Header End -->
     ...
     <div id="box" class=" control-group bg-white">
        <form method="post">
            ...
            <input id="text" type="text" name="secondname"> <br><br>
            <label for="eaddr"><b>Email Address</b></label>
            <input id="text" type="text" name="email_address"> <br><br>
            <label for="phno"><b>Phone Number</b></label>
            <input id="text" type="text" name="phone_no"> <br><br>

            <input class= "btn btn-primary btn-block" type="submit" value="Signup"> <br><br>
